...
class _OrderSuggestionPageState extends State<OrderSuggestionPage> {
  ...
  Future<void> _confirmOrder() async {
    ...
    final double walletBalance =_convertToDouble(profile?.wallet) ;   // ✅ Dynamic wallet balance
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: SingleChildScrollView( // ✅ overflow fix
          child: Column(
            mainAxisSize: MainAxisSize.min,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              final body = {
                ...
                "ingamepassword": ingamepassword,
                "securitycode": securitycode,
                "payment_method": payment_method, // 1 = Wallet, 2 = Auto Payment
              };
        ...
        return GestureDetector(
          ...
          onTap: () {
            setState(() {
              ...
              selectedPackagePrice = _convertToDouble(pack["price"]); // ✅ এখানেই দাম আপডেট হচ্ছে
  ...
  Widget build(BuildContext context) {
    ...
    final bool canBuy = isLoggedIn &&
        (
            selectedPayment == "Auto Payment" || // Auto Payment এ সবসময় buy করা যাবে
                (
                    selectedPayment == "RRR Bazar Wallet" &&
                        selectedPackagePrice != null && // প্রথমে চেক করছি price select হয়েছে কিনা
                        walletBalance >= selectedPackagePrice! // এখন চেক করছি ব্যালেন্স যথেষ্ট কি না
                )
        );
